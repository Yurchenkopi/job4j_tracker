...
public class ThenComparingMethodTest {
    ...
    public void test() {
        ...
        ThenComparingMethod.User user3 = new ThenComparingMethod.User("A", 12);
        ThenComparingMethod.User user4 = new ThenComparingMethod.User("B", 11);
        ThenComparingMethod.User user5 = new ThenComparingMethod.User("A", 15);
        List<ThenComparingMethod.User> input = Arrays.asList(user1, user2, user3, user4, user5);
        List<ThenComparingMethod.User> expect = Arrays.asList(user5, user3, user2, user4, user1);
